  ...
  return (
    <section ref={scrollRef} className="relative min-h-[200vh] bg-gray-100">
      ...
      <motion.div
        ...
        style={{ backgroundImage: `url(${img4})`, y: yPos4, zIndex: 4, rotate: "-8deg" }}
      />
      <motion.div
      ...
      {/* Sticky Text Content */}
      <div className="sticky top-16 sm:top-24 lg:top-32 z-20 flex flex-col items-center justify-center text-center px-2 sm:px-6 md:px-12 h-screen">
        <motion.h1
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          className="text-base sm:text-lg md:text-xl mb-4 sm:mb-6 text-gray-700 max-w-lg"
        >
          With CODEMATRIX
        </motion.p>
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          className="text-sm sm:text-base md:text-lg mb-6 sm:mb-8 text-gray-600 max-w-xl"
        >
